...
const (
	// Label holds the string label denoting the foods type in the database.
	Label = "foods"
	...
	EdgeOrders = "Orders"
	// Table holds the table name of the foods in the database.
	Table = "foods"
	...
	OrdersColumn = "food_id"
)

// Columns holds all SQL columns for foods fields.
var Columns = []string{
	FieldID,
	FieldDeletedAt,
	FieldName,
...
// OrderOption defines the ordering options for the Foods queries.
