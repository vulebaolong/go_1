...
func (t *tokenUsecase) VerifyAccessToken(accessToken string) (*dto.CustomClaim, error) {
	claim := &dto.CustomClaim{}
	tokenClaim, err := jwt.ParseWithClaims(accessToken, claim, func(*jwt.Token) (any, error) {
